...
<p style="margin-top: 1em;">
  The code for our pipeline is publicly available at: <br>
  <a href="https://github.com/Andrade-Miranda/PINKCC_CERIS" target="_blank">https://github.com/Andrade-Miranda/PINKCC_CERIS</a>
</p>


<div style="text-align: center; margin-top: 2em;">
  <img src="/images/PINKCC.jpeg" alt="PINKCC Photo" style="max-width: 100%; height: auto;">
  <div style="font-size: 0.9em; color: #555; margin-top: 0.5em;">
     <em> Team CERIS in action during the PINKCC Challenge — collaborative effort, focus, and some coffee-powered segmentation breakthroughs.</em>
  </div>
</div>